...
export default function SignUpPage() {
  ...
  const handleLogin = async () => {
    try {
      if (!info.email) throw new Error("Please input your email");
      if (!validator.isEmail(info.email)) throw new Error("Invalid email");
      if (!info.password) throw new Error("Please input your password");
      if (!info.role) throw new Error("Please input your role");
      ...
      <div className="flex h-screen w-screen">
        ...
        >
          ...
          <InputBox
            ...
            onChangeHandler={onChangeHandler}
          />
          <h4 className="text-white text-lg">Who are you?</h4>
          <div className="flex">
            <div className="">
              <input
                type="radio"
              ...
              />
              <label htmlFor="AUTHOR" className="text-white mr-2">
                Author
              </label>
            </div>
            <div className="">
              <input
                ...
                onClick={onChangeHandler}
              />
              <label htmlFor="editor" className="text-white mr-2">
                Editor
              </label>
            </div>
          </div>
